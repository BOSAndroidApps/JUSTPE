...
import com.bos.payment.appName.data.model.fastTag.fastTagOperator.Data

class FastTagListSpinnerAdapter(context: Context, model: ArrayList<Data>) :
    ArrayAdapter<Data>(context, 0, model) {
