...
class AirTicketCompletedAdapter(private var context: Context, private var passangerList: MutableList<com.bos.payment.appName.data.model.travel.flight.airbookingticketList.DataItem>, var fragment: CompletedAir) :
    RecyclerView.Adapter<AirTicketCompletedAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.viewtxt.text="VIEW TICKET"
